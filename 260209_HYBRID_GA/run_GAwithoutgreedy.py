...
def run_ga_without_greedy():
    # 1. 파일 및 파라미터 설정
    target_filename = "testset2/cycle318.in"  # [수정 필요]
    ...
    # 2. 엔진 초기화
    engine = GA_Engine(full_path, params, run_name="run_GAwithoutgreedy", seed=0)

    print(f"🚀 Start GA without Greedy (Random Init) on {target_filename}")
